...
main:
    ...
    nor     $a1, $a1, $zero     # set Counter i = 8
...
PRINT_HEX: 
    # $a0: a register, $a1: i; $v0: void

    # Store temporarily PRINT_HEX's return address in $s2
    or      $t7, $zero, $ra     # $t7 = $ra

    jal		REVERSE				# jump to REVERSE and save position to $ra
    
    # Store REVERSED register
    or      $s1, $zero, $v0
    
    # Reset Counter i and $ra for PRINT_HEX
